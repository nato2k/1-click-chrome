  ...
  Autocomplete.prototype = {
    ...
    getSuggestions: function(q) {
      ...
      if (cr && $.isArray(cr.suggestions)) {
        ...
        me.options.params.where = q;
	    	...
	    	isValidZipCode(function() { loading.finish(); }, function() { me.processSuggestions(me); }, function() { me.processSuggestions(me); });
      }
    },
    
    processSuggestions : function(me) {
    	$.get(me.options.serviceUrl, me.options.params, function(txt) { me.processResponse(txt); }, 'text');
    },
    ...
    processResponse: function(text) {
      ...
      var parser=new DOMParser();
		  ...
		  while (fullCountNode) {
			  if ( (region == 'DE' && fullCountNode.attributes.getNamedItem("id").nodeValue.indexOf('GM') != 0) ||
			  		(region == 'BR' && fullCountNode.attributes.getNamedItem("id").nodeValue.indexOf('BR') != 0)) {
